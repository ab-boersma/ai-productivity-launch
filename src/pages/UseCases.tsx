      ...
      <section className="relative px-6 pt-14 lg:px-8">
        <div className="mx-auto max-w-2xl py-32 sm:py-48">
          <div className="text-center animate-fade-up">
            <Badge className="mb-6 bg-slate-docket text-pure-white">Use Cases</Badge>
            <h1 className="text-4xl font-bold tracking-garamond text-midnight-brief sm:text-6xl">
              AI Solutions for Every Legal Challenge
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Discover how White Shoe AI transforms specific legal workflows across departments. 
              From contract review to compliance management, see measurable results.
            </p>
          </div>
        </div>
      </section>
